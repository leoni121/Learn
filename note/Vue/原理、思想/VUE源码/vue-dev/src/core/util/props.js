...
export function validateProp (
  ...
  // check default value
  // 外界没有为组件传递该 prop 时，则取默认值作为该 prop 的数据
  if (value === undefined) {
...
function getPropDefaultValue (vm: ?Component, prop: PropOptions, key: string): any {
  ...
  if (vm && vm.$options.propsData &&
    // 执行到了 getPropDefaultValue 函数那么说明外界没有向组件传递该 prop 数据，
...
// 用来查找第一个参数所指定的类型构造函数是否存在于第二个参数所指定的类型构造函数数组中
